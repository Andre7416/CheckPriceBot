            ...
            for link, price in data_check.get(user_id, {}).items():
                ...
                if price != new_price and new_price != 1e12:
                    ...
                    await bot.send_message(
                        user_id,
                        f'Цена на товар "{parse.get_info()}" {word} на {delta} '
...
async def add(message: types.Message):
    await Form.url.set()
    await message.answer(
        "Жду ссылку на интересующий товар с сайта https://www.farfetch.com/ru или "
...
if __name__ == "__main__":
    ...
    executor.start_polling(
        dp, skip_updates=True, loop=loop, on_startup=print("Я родился!")
    )
